                    ...
                    <section className="about_section layout_padding long_section" style={{ backgroundColor: '#f9fafa' }} data-aos={isHomePage ? "fade-up" : ""}>
                        <div className="container">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="row row-cols-2 row-cols-md-4 row-cols-lg-5 row-cols-xl-6 g-3 custom-scroll" style={{ maxHeight: isFlashcardPage ? undefined : "350px", overflow: isFlashcardPage ? "visible" : "auto" }} data-aos={isHomePage ? "zoom-in" : ""}>
