    ...
    import covn from '../../assets/image/covn.png'
    ...
    return (
        <div>
        {/* Container Fluid */}
        <div className="flashcardcanh-container-fluid">
            <a href="#" className="flashcardcanh-btn-back">Quay lại</a>
        ...
        {/* Flashcard Wrapper */}
        <div className="flashcardcanh-flashcard-wrapper">
            {/* Flashcard 1 */}
