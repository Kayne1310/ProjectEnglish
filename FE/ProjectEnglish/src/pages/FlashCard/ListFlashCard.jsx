                        ...
                        {flashcard.map((data, index) => (
                            <div className="row m-1">
                                <Link
                                    ...
                                    className=" d-block w-100 bg-white rounded shadow-sm p-3 border text-decoration-none transition-all custom-link"
                                    style={{ height: "210px", width: "210px", display: "flex", flexDirection: "colum", Justify: "space-between", backgroundColor: "white", }}
                                >
                                    {/* Title */}
