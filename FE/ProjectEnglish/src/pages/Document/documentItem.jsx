    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                console.log("data flashcard ",result);
                setData(result);
        ...
        <>
            <section className="light mt-5" >
                <div className="container py-2">
                    <div className="document-title text-center mb-4" id="pageHeaderTitle">
                        Tài liệu : {title}
                    </div>
                    <div className="mb-4">
                        <Row className="align-items-center">
                            ...
                            <Col xs={12} md={4} className="text-center text-md-end">
                                <Link
                                    to={`/listdocument/detaildocument/flashcard/${id}`}
                                    className="flashcard-btn btn btn-primary d-inline-flex align-items-center gap-2"
                                >
                                    ...
                                    <span>Luyện tập bằng Flashcard</span>
                                </Link>
                            </Col>
                        </Row>
                    </div>
