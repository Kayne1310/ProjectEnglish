...
const ResetPasswordPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        handleResetPassword(password,email,token, setError, setIsLoading, setIsSuccess);
    };
            ...
            <div className="containers" style={{ maxWidth: "350px", background: "#fff", padding: "20px", borderRadius: "10px", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.1)" }}>
                <div className="form-box">
                    <form onSubmit={handleSubmit} style={{ textAlign: "center" }}>
                        ...
                        <p>
                            <Link to="/loginuser" style={{ color: "#13d420", textDecoration: "underline", fontFamily: "inherit" }}>
                                Back to Login
                            </Link>
                        </p>
                    </form>
